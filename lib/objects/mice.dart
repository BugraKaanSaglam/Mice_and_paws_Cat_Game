...
class Mice extends SpriteComponent with HasGameRef<FlameGame>, CollisionCallbacks {
  ...
  Mice(Vector2 position, Vector2 velocity, double speed)
      : _velocity = velocity,
        _speed = speed,
        super(sprite: Sprite(globalMiceImage), position: position, size: Vector2(75, 75), anchor: Anchor.center) {
    add(RectangleHitbox());
  }
